      ...
      <StoryContainer>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '24px' }}>
            <PropCard label="Default (Responsive)">
              <Container
                style={{
            ...
            <PropCard label="Fluid (Full Width)">
              <Container
                fluid
                style={{
                  backgroundColor: STORY_COLORS.themed.background.surface,
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                {sizes.map((size, index) => {
                  ...
                  return (
                    ...
                    >
                      <div style={{ backgroundColor: colors.main, color: STORY_COLORS.neutral.white, padding: '1rem' }}>
                        size="{size}"
                      </div>
                    </Container>
                  );
