...
- Destructive actions with clear error styling
...
| `variant`   | `'primary' \| 'secondary' \| 'success' \| 'error' \| 'warning' \| 'info' \| 'neutral'` | `'primary'` | Semantic color variant                               |
...
- Use `variant="error"` for destructive actions.
...
- Don't use `variant="error"` for non-destructive actions.
